        ...
        try {
            ...
            for (let num of participants) {
                ...
                try {
                    ...
                    ppuser = 'https://i.ibb.co/xjGSFDy/20221012-151724.jpg'
                }
                ...
                try {
                    ...
                    ppgroup = 'https://i.ibb.co/xjGSFDy/20221012-151724.jpg'
                }

                if (anu.action == 'add') {
                    naze.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: `Welcome To ${metadata.subject} @${num.split("@")[0]} Jangan lupa intro ya deck🤭` })
                } else if (anu.action == 'remove') {
                    naze.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: `@${num.split("@")[0]} Leaving To ${metadata.subject} Semoga Harimu suram 🤭` })
